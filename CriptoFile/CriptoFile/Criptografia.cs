...
namespace CriptoFile
{
    class Criptografia
    {
        // Declaração de CspParameters e RsaCrpytoServiceProvider
        ...
        public static string EncryptFile(string inFile)
        {
            ...
            // O RSA foi instanciado anteriormente 

            byte[] keyEncrypted = rsa.Encrypt(aes.Key, false);

            // Crie as matrizes de bytes para conter os valores de comprimento da chave e IV.
        ...
        public static string DecryptFile(string inFile)
        {
            ...
            try
            {
                // Use objetos FileStream para ler o criptografado (inFs) e salve o arquivo descriptografado
                using (FileStream inFs = new FileStream(EncrFolder + inFile, FileMode.Open))
                {
                    ...
                    // Crie as matrizes de bytes para a chave Aes criptografada, o objeto IV e o texto cifrado
                    ...
                    // Descriptografar o texto cifrado do FileStream do arquivo(inFs) criptografado no FileStream para o arquivo descriptografado(outFs).
                    using (FileStream outFs = new FileStream(outFile, FileMode.Create))
                    {
                        int count = 0;
                        int offset = 0;
